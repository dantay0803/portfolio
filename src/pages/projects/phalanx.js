        ...
        <Row noGutters>
          <Col xs={{ span: 10, offset: 1 }} md={{ span: 6, offset: 3 }}>
            <p>
              ...
              systems on a single software platform. PHALANX contains a number
              of process to help employees carry out their work in a more
              streamlined and efficient manner and help reduce a businesses use
              of paper.
            </p>
          </Col>
        </Row>
        ...
        <Row noGutters>
          <Col xs={{ span: 10, offset: 1 }} md={{ span: 6, offset: 3 }}>
            <p>
              ...
              languages such as C#, JavaScript and SQL. Along side frameworks
