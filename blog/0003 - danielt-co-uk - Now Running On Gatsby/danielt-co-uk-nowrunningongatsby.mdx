...
<figure>
  <img
    src="GatsbyUpdateSpeedTest-1024x500.png"
    alt="danielt.co.uk – New Speed Test Results"
  />
...
<figure>
  <img
    src="GatsbyUpdateOptimizeSite-1024x127.png"
    alt="The optimize website option found in cPanel "
  />
